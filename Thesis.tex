...
\usepackage{makecell}
\usepackage{rotating} % Needed for vertical text
...
\lfbdasatitle{Master Thesis}        % or Bachelor Thesis                   
			...
			for 3D Cell Segmentation in Microscopy Data	}     % Titel der Arbeit
             {Title in second language}      % Deutscher Titel der Arbeit, or English
             {Daniel Geiger, B.Sc.}                     % Name des Studenten
             {Zhu Chen, M.Sc.}          % Betreuer. Dr. Strange or Strange, M.Sc.	
             {2025}                                  % Jahr
             {Aachen, 28.11.2025} 	% Ort,Datum (Erklärung) -- Abgabedatum
...
\include{Chapters/020_sota}
\include{Chapters/030_methods}
\include{Chapters/040_experiments}
\include{Chapters/050_results}
\include{Chapters/060_Discussion_and_Future_Work}
\cleardoublepage 
